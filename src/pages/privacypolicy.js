	...
	return (
		<div className={styles.container}>
			...
			<Row className={styles.row}>
				...
				<p>
					...
					<ul>
						...
						<li>
							...
							You on any electronic device, named ContentGhar
						</li>
						<li>
							<b>Company </b>
							referred to as either the Company, We, Us or Our in this Agreement
							refers to ContentGhar Inc, 8700 McKim Way, Unit 3098, Richmond,
							British Columbia, V6X 4A5, Canada.
						</li>
						<li>
							<b>Country </b>
							refers to: BC, Canada
				...
				<h1>Information from Third-Party Social Services</h1>
				<p>
				...
				<ul>
					...
					<li>
						...
						contracting, and support of the Service.
					</li>
					<li>
						<b>To contact You:</b> To contact You by email, telephone calls,
						SMS, or other equivalent forms of electronic communication,
						including for customer service purposes, to provide You with updates
						and other information relating to the Service, and for marketing and
				...
				<ul>
					...
					<li>
						...
						advertised outside the Service in perpetuity. If You interact with
